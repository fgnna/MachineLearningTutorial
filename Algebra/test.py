...
class LinearRegressionTestCase(unittest.TestCase):
    ...
    def test_shape(self):
        ...
        for _ in range(10):
            ...
            self.assertEqual(line2.shape(matrix.tolist()), (r, c), 'Wrong answer')
    ...
    def test_transpose(self):
        for _ in range(100):
            ...
            mat = matrix.tolist()
            t = np.array(line2.transpose(mat))
    ...
    def test_matxMultiply(self):
        ...
        for _ in range(100):
            ...
            dp = np.array(line2.matxMultiply(mat1.tolist(), mat2.tolist()))
        ...
        with self.assertRaises(ValueError, msg="Matrix A\'s column number doesn\'t equal to Matrix b\'s row number"):
            line2.matxMultiply(mat1.tolist(), mat2.tolist())
        with self.assertRaises(ValueError, msg="Matrix A\'s column number doesn\'t equal to Matrix b\'s row number"):
            line2.matxMultiply(mat1.tolist(), mat3.tolist())
    ...
    def test_augmentMatrix(self):
        ...
        for _ in range(50):
            ...
            Ab = np.array(line2.augmentMatrix(Amat, bmat))
            ab = np.hstack((A, b))
    ...
    def test_scaleRow(self):
        ...
        for _ in range(10):
            ...
            with self.assertRaises(ValueError):
                line2.scaleRow(mat, rr, 0)

            scale = np.random.randint(low=1, high=10)
            line2.scaleRow(mat, rr, scale)
            matrix[rr] *= scale
    ...
    def test_addScaledRow(self):
        ...
        for _ in range(10):
            ...
            scale = np.random.randint(low=1, high=10)
            line2.addScaledRow(mat, r1, r2, scale)
